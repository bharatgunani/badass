    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'required'  => true,
                'after_element_html' => '<br><small><p>Randomizer feature is available. The construction like [Buy||Order||Purchase] will use a randomly picked word for each next item when applying a template.<br>
                    ...
                    <p>HTC Touch Diamond by HTC of Black color for only € 517.50<br></small>',
                ]
        );
