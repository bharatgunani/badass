        ...
        return colGrid.extend({
            ...
            initialize: function () {
                ...
                ko.pureComputed(function () {
                    ...
                    if (self.orderData()) {
                        ...
                        self.remainTotal(PriceHelper.convertAndFormat(
                            self.baseRemainTotal(),
            ...
            addPayment: function (data) {
                ...
                this.selectedPayments.push({
                    ...
                    cart_total: this.baseRemainTotal(),
                    paid_amount: this.baseRemainTotal(),
                    base_cart_total_formated: this.baseRemainTotal(),
                    cart_total_formated: PriceHelper.convertAndFormat(
            ...
            reCalculateTotal: function (selectedId) {
                ...
                this.remainTotal(PriceHelper.convertAndFormat(
