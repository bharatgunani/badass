...
class View extends \Magestore\Giftvoucher\Block\Account
{
    ...
    public function getActions($row)
    {
        ...
        $giftvoucher = $this->getModel('Magestore\Giftvoucher\Model\Giftvoucher')->load($row->getVoucherId())->getGiftcardTemplateId();
        $canPrint    = !$row->getSetId() || ($row->getStatus() == \Magestore\Giftvoucher\Model\Status::STATUS_ACTIVE);
        if ($row->getStatus() < \Magestore\Giftvoucher\Model\Status::STATUS_DISABLED && $giftvoucher && $canPrint) {
