var config = {
	...
	shim: {        
			"Mageplaza_SocialLogin/js/sociallogin": ["jquery"],
			"Mageplaza_SocialLogin/js/jquery/jquery.magnific-popup.min": ["jquery"],
			"Mageplaza_SocialLogin/js/sociallogin/form": ["jquery"]
	}
