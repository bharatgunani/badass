...
class Save extends \Mageplaza\Blog\Controller\Adminhtml\Post {
    ...
    \Mageplaza\Blog\Model\Upload $uploadModel, \Mageplaza\Blog\Model\Post\Image $imageModel, \Mageplaza\Blog\Model\TrafficFactory $trafficFactory, \Magento\Backend\Model\Session $backendSession, \Magento\Backend\Helper\Js $jsHelper, \Mageplaza\Blog\Model\PostFactory $postFactory, \Magento\Framework\Registry $registry, \Magento\Backend\Model\View\Result\RedirectFactory $resultRedirectFactory, \Magento\Backend\App\Action\Context $context
    ) {
    ...
    public function execute() {
        ...
        if ($data) {
            ...
            //custom coding by web india
            if ($image) {
                if (strpos($image, 'mageplaza/blog/post/image') !== false) {
                    $post->setImage($image);
                } else {
