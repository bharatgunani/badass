...
class Data extends AbstractHelper {
    ...
    Context $context, ObjectManagerInterface $objectManager, StoreManagerInterface $storeManager, PostFactory $postFactory, CategoryFactory $categoryFactory, TagFactory $tagFactory, TopicFactory $topicFactory
    ) {
    ...
    public function getUrlByPost($post) {
        if ($post->getUrlKey()) {
            ...
            if ($url_prefix) {
                //$urlKey .= $url_prefix . '/';
                /* custom Coding By Webindia */
                $urlKey .= 'blog/post/view/id/' . $post->getId();
                /* custom Coding By Webindia */
            }
