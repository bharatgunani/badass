...
class Post extends \Magento\Framework\Model\AbstractModel {
    ...
    public function getSelectedTagsCollection() {
        if (is_null($this->tagCollection)) {
            ...
            $collection->join(
                    'mageplaza_blog_post_tag', 'main_table.tag_id=mageplaza_blog_post_tag.tag_id AND mageplaza_blog_post_tag.post_id=' . $this->getId(), ['position']
            );
    ...
    public function getSelectedTopicsCollection() {
        if (is_null($this->topicCollection)) {
            ...
            $collection->join(
                    'mageplaza_blog_post_topic', 'main_table.topic_id=mageplaza_blog_post_topic.topic_id AND mageplaza_blog_post_topic.post_id=' . $this->getId(), ['position']
            );
    ...
    public function getSelectedCategoriesCollection() {
        if (is_null($this->categoryCollection)) {
            ...
            $collection->join(
                    'mageplaza_blog_post_category', 'main_table.category_id=mageplaza_blog_post_category.category_id AND mageplaza_blog_post_category.post_id=' . $this->getId(), ['position']
            );
    ...
    public function getRelatedPostsCollection() {
        if ($this->getTopicSting()) {
            ...
            $collection->join(
                    'mageplaza_blog_post_topic', 'main_table.post_id=mageplaza_blog_post_topic.post_id AND mageplaza_blog_post_topic.post_id != ' . $this->getId() . ' AND mageplaza_blog_post_topic.topic_id IN (' . $this->getTopicSting() . ')', ['position']
            );
