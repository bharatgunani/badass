...
//                            if(!$stockData)
//                                $stockData = $product->getStockItem();
//                            if(trim($columnValuesForUpdate[$itemId][0]) != '')
                            if(trim($columnValuesForUpdate[$itemId]) != '')
                            {
                                ...
                                if($this->_scopeConfig->getValue('iksanika_productmanage/stockmanage/autoStockStatus'))
                                {
                                    $product->setData('quantity_and_stock_status', array('qty' => $qty, 'is_in_stock' => ($qty > 0) ? 1 : 0));
                                }else
                                {
                                    $product->setData('quantity_and_stock_status', array('qty' => $qty));
                                }
*/
                                //////////
...
//                                $product->$columnName =  $columnValuesForUpdate[$itemId];
                        ...
                        if($columnName != 'product' && $columnName != 'entity_id' && $columnName != 'category')
