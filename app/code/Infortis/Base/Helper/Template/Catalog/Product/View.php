...
class View extends AbstractHelper
{
    ...
    protected function calculateGridClasses()
    {
        ...
        $lowerSecColUnits_two       = $this->theme->getCfg('product_page/lower_secondary_column_two');
        ...
        if(!empty($lowerSecColUnits_two)){
            $this->grid['lowerSecCol_two']    = $prefix . $lowerSecColUnits_two;
        }
    }
