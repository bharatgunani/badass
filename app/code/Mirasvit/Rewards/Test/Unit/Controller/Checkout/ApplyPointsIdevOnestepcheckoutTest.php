...
/**
 * @covers \Mirasvit\Rewards\Controller\Checkout\ApplyPointsIdevOnestepcheckout
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class ApplyPointsIdevOnestepcheckoutTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var ObjectManager
     */
    ...
    /**
     * @var \Mirasvit\Rewards\Controller\Checkout\ApplyPointsIdevOnestepcheckout|
    ...
    public function setUp()
    {
        ...
        $this->checkoutController = $this->objectManager->getObject(
            '\Mirasvit\Rewards\Controller\Checkout\ApplyPointsIdevOnestepcheckout',
            [
