...
/**
 * @covers \Mirasvit\Rewards\Controller\Checkout\ApplyPointsApptanaOnestepcheckout
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class ApplyPointsApptanaOnestepcheckoutTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var ObjectManager
     */
    ...
    /**
     * @var \Mirasvit\Rewards\Controller\Checkout\ApplyPointsApptanaOnestepcheckout|
    ...
    public function setUp()
    {
        ...
        $this->checkoutController = $this->objectManager->getObject(
            '\Mirasvit\Rewards\Controller\Checkout\ApplyPointsApptanaOnestepcheckout',
            [
