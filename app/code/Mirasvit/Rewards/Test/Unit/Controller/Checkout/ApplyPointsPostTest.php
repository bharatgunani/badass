...
/**
 * @covers \Mirasvit\Rewards\Controller\Checkout\ApplyPointsPost
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class ApplyPointsPostTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var ObjectManager
     */
    ...
    /**
     * @var \Mirasvit\Rewards\Controller\Checkout\ApplyPointsPost|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    public function setUp()
    {
        ...
        $this->checkoutController = $this->objectManager->getObject(
            '\Mirasvit\Rewards\Controller\Checkout\ApplyPointsPost',
            [
