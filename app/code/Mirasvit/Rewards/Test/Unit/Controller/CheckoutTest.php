...
/**
 * @covers \Mirasvit\Rewards\Controller\Checkout
...
class CheckoutTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Mirasvit\Rewards\Controller\Checkout|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    {
        $this->typeOnepageMock = $this->getMock('\Mirasvit\Checkout\Model\Type\Onepage', [], [], '', false);
        ...
        $this->checkoutController = $this->getMockForAbstractClass(
            '\Mirasvit\Rewards\Controller\Checkout',
            [
