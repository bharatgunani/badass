...
/**
 * @covers \Mirasvit\Rewards\Controller\Adminhtml\Transaction\Customergrid
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class CustomergridTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var ObjectManager
     */
    ...
    /**
     * @var \Mirasvit\Rewards\Controller\Adminhtml\Transaction\Customergrid|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    public function setUp()
    {
        ...
        $this->transactionController = $this->objectManager->getObject(
            '\Mirasvit\Rewards\Controller\Adminhtml\Transaction\Customergrid',
            [
