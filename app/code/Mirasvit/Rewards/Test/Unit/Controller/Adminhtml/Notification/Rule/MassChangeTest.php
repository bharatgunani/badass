...
/**
 * @covers \Mirasvit\Rewards\Controller\Adminhtml\Notification\Rule\MassChange
...
class MassChangeTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Mirasvit\Rewards\Controller\Adminhtml\Notification\Rule\MassChange|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    public function setUp()
    {
        ...
        $this->ruleController = $this->objectManager->getObject(
            '\Mirasvit\Rewards\Controller\Adminhtml\Notification\Rule\MassChange',
            [
