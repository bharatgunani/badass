...
namespace Mirasvit\Rewards\Test\Unit\Model\Spending\Rule\Action;

use Magento\Framework\TestFramework\Unit\Helper\ObjectManager as ObjectManager;

/**
 * @covers \Mirasvit\Rewards\Model\Spending\Rule\Action\Collection
 */
class CollectionTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Mirasvit\Rewards\Model\Spending\Rule\Action\Collection|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    public function setUp()
    {
        ...
        $this->collectionModel = $this->objectManager->getObject(
            '\Mirasvit\Rewards\Model\Spending\Rule\Action\Collection',
            [
