...
/**
 * @covers \Mirasvit\Rewards\Model\Notification\Rule\Condition\Product
...
class ProductTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->productFactoryMock = $this->getMock(
            '\Magento\Catalog\Model\ResourceModel\ProductFactory', ['create'], [], '', false
        );
        ...
        $this->productModel = $this->objectManager->getObject(
            '\Mirasvit\Rewards\Model\Notification\Rule\Condition\Product',
            [
