...
/**
 * @covers \Mirasvit\Rewards\Helper\Rule
 */
class RuleTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->entityAttributeFactoryMock = $this->getMock(
            '\Magento\Eav\Model\Entity\AttributeFactory', ['create'], [], '', false
        );
        $this->entityAttributeMock = $this->getMock(
            '\Magento\Eav\Model\Entity\Attribute', ['load', 'save', 'delete'], [], '', false
        );
        ...
        $this->systemConfigSourceAttributeMock = $this->getMock(
            '\Mirasvit\Rewards\Model\System\Config\Source\Attribute', [], [], '', false
        );
        $this->objectManagerMock = $this->getMockForAbstractClass(
            '\Magento\Framework\ObjectManagerInterface', [], '', false, true, true, []
        );
