...
/**
 * Admin Rewards Earning Rule Delete Test.
 */
...
class DeleteTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/rewards/earning_rule/delete';
        parent::setUp();
    }

    /**
     * @covers  Mirasvit\Rewards\Controller\Adminhtml\Earning\Rule\Delete::execute
     */
    public function testDeleteAction()
    {
        $this->getRequest()->setParam('id', 1);
        $this->dispatch('backend/rewards/earning_rule/delete');
        $this->assertNotEquals('noroute', $this->getRequest()->getControllerName());
        $this->assertTrue($this->getResponse()->isRedirect());
        $this->assertSessionMessages(
            $this->equalTo(['Earning Rule was successfully deleted']),
