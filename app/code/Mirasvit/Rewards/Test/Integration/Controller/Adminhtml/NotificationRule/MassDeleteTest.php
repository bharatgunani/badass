...
/**
 * Admin Notification Rule Mass Delete Test.
 */
...
class MassDeleteTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/rewards/notification_rule/massdelete';
        parent::setUp();
    }
    ...
    public function testMassDeleteAction()
    {
        ...
        $this->dispatch('backend/rewards/notification_rule/massdelete');
