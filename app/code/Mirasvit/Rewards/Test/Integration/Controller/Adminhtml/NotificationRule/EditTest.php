...
class EditTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/rewards/notification_rule/edit';
        parent::setUp();
    }

    /**
     * @covers  Mirasvit\Rewards\Controller\Adminhtml\Notification\Rule\Edit::execute
     */
    public function testAddAction()
    {
        $this->getRequest()->setParam('id', 1);
        $this->dispatch('backend/rewards/notification_rule/edit');
        $body = $this->getResponse()->getBody();
        $this->assertNotEmpty($body);
        $this->assertNotEquals('noroute', $this->getRequest()->getControllerName());
        $this->assertFalse($this->getResponse()->isRedirect());
        $this->assertContains('Test Notification Rule', $body);
    }
}
