 ...
 */
class OneTest extends \Magento\TestFramework\TestCase\AbstractController
{
    ...
    /**
     *
     * @covers  Mirasvit\Rewards\Controller\Googleplus\One::execute
     *
    ...
    public function testOneAction()
    {
        ...
        $this->dispatch('rewards/googleplus/one');

        $body = $this->getResponse()->getBody();

        $this->assertContains("You've earned 15 Reward Points for Google+!", $body);
    }
}
