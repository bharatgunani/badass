 ...
 */
class LikeTest extends \Magento\TestFramework\TestCase\AbstractController
{
    ...
    /**
     *
     * @covers  Mirasvit\Rewards\Controller\Facebook\Like::execute
     *
    ...
    public function testLikeAction()
    {
        ...
        $this->dispatch('rewards/facebook/like');

        $body = $this->getResponse()->getBody();

        $this->assertContains("You've earned 15 Reward Points for Facebook Like!", $body);
    }
}
