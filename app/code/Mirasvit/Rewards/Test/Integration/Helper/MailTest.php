...
class MailTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->helper = $this->objectManager->create('Mirasvit\Rewards\Helper\Mail');
    }
     ...
     */
    public function testSendNotificationBalanceUpdateEmailMail()
    {
        $transaction = $this->objectManager->create('Mirasvit\Rewards\Model\Transaction')
            ->getCollection()->getFirstItem();

        $this->helper->sendNotificationBalanceUpdateEmail($transaction, false);
        ...
        $this->assertEquals(
            $this->getExpectedMail('notification_balance_update_email_template'),
            $actual
        );
    }
     ...
     * @magentoDataFixture Mirasvit/Rewards/_files/customer.php
     */
    public function testSendNotificationPointsExpireEmail()
    {
        /** @var \Mirasvit\Rewards\Model\Transaction $transaction */
        $transaction = $this->objectManager->create('Mirasvit\Rewards\Model\Transaction')
            ->getCollection()->getFirstItem();

        $this->helper->sendNotificationPointsExpireEmail($transaction, false);
        ...
        //                echo $actual;die;
        $this->assertEquals(
            $this->getExpectedMail('notification_points_expire_email_template'),
            $actual
        );
    }
     ...
     */
    public function testSendReferralInvitationEmail()
    {
        /** @var \Mirasvit\Rewards\Model\Referral $referral */
        $referral = $this->objectManager->create('Mirasvit\Rewards\Model\Referral')
              ->getCollection()->getFirstItem();
        ...
        $actual = $this->htmlToText($transportBuilder->getSentMessage()->getBodyHtml()->getRawContent());
        $this->assertEquals(
            $this->getExpectedMail('referral_invitation_email_template'),
            $actual
        );
    }
