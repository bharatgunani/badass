...
class Points extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    public function __construct(
        \Mirasvit\Rewards\Reports\DynamicConfig $dynamicConfig,
        ...
        foreach ($aggregateTables as $table => $periodFormat) {
            ...
            $select = $adapter->select()
                ...
                ->joinInner($customerTable, 'points_table.customer_id = '.$customerTable.'.entity_id',
                    new \Zend_Db_Expr($customerTable.'.store_id, '.$customerTable.'.group_id as customer_group_id'))
     ...
     * @return void
     */
    private function addRulesToConfig($tables)
    {
        $this->dynamicConfig->updateConfig($tables, $this->ruleTypes);
    }
