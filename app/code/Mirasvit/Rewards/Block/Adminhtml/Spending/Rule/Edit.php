...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        if (
            $this->registry->registry('current_spending_rule') &&
            $this->registry->registry('current_spending_rule')->getId()
        ) {
            return $this->registry->registry('current_spending_rule');
        }
    }
    ...
    public function getHeaderText()
    {
        if ($spendingRule = $this->getSpendingRule()) {
            return __("Edit Spending Rule '%1'", $this->escapeHtml($spendingRule->getName()));
        } else {
            return __('Create New Spending Rule');
        }
    }
