...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        $collection = $this->earningRuleFactory
            ->create()
            ->getCollection()
            ->addEarnPointsColumn()
            ->addWebsiteColumn();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('earn_points', [
                'header'       => __('Number of points to earn'),
                'index'        => 'earn_points_str',
                'filter_index' => 'earn_points',
            ]
        );
    ...
    /**
     * @param \Mirasvit\Rewards\Model\ResourceModel\Earning\Rule\Collection $collection
